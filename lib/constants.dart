...
// Social Media
const List<String> kSocialIcons = [
...
const List<String> kSocialLinks = [
...
// Community
final List<String> kCommunityLogo = [
  'assets/cui.png',
  'assets/flutterIsl.png',
  'assets/dsc.png'
];

final List<String> kCommunityLinks = [
...
// services
final List<String> kServicesIcons = [
...
final List<String> kServicesTitles = [
...
final List<String> kServicesDescriptions = [
...
final List<String> kServicesLinks = [
...
// projects
final List<String> kProjectsBanner = [
...
final List<String> kProjectsIcons = [
...
final List<String> kProjectsTitles = [
  "MedKit",
  "The Holy Qur'an",
  "Here I Am",
  "COVID-19",
...
final List<String> kProjectsDescriptions = [
...
final List<String> kProjectsLinks = [
];

// Contact
final List<IconData> kContactIcons = [
  Icons.home,
  Icons.phone,
  Icons.mail,
];

final List<String> kContactTitles = [
  "Location",
  "Phone",
  "Email",
];

final List<String> kContactDetails = [
  "Attock, Pakistan",
  "(+92) 346 0159889",
  "hamza@mhmz.dev"
];